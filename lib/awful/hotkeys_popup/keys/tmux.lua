...
--
-- will show tmux hotkeys for any window that has 'tmux' in it's title.
-- If no rules passed then tmux hotkeys will always be shown!
-- @function add_rules_for_terminal
-- @see awful.rules.rules
-- @param rule Rules to match a window with tmux session
