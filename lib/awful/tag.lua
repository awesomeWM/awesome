...
-- @tparam table padding The table {left, right, top, bottom}
-- @tparam[opt=tag.selected()] table t The tag
...
-- @tparam[opt=tag.selected()] table t The tag
-- @treturn table The table {left, right, top, bottom}, if no padding for tag then try
